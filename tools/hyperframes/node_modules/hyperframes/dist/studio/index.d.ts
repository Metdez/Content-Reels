...
import * as _hyperframes_parsers_gsap_parser from '@hyperframes/parsers/gsap-parser';
import { GsapAnimation } from '@hyperframes/parsers/gsap-parser';
...
interface PropertyPanelProps {
    ...
    gsapAnimations?: _hyperframes_parsers_gsap_parser.GsapAnimation[];
    ...
    onSetArcPath?: (animId: string, config: {
        ...
        segments?: _hyperframes_parsers_gsap_parser.ArcPathSegment[];
    }) => void;
    onUpdateArcSegment?: (animId: string, segmentIndex: number, update: Partial<_hyperframes_parsers_gsap_parser.ArcPathSegment>) => void;
